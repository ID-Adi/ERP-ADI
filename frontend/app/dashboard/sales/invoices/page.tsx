...
const dummyInvoices = [
  {
    id: '1',
    invoiceNumber: 'INV.2024.12.00482',
  ...
  {
    id: '2',
    invoiceNumber: 'INV.2024.12.00487',
  ...
  {
    id: '3',
    invoiceNumber: 'INV.2024.12.00486',
  ...
  {
    id: '4',
    invoiceNumber: 'INV.2024.12.00041',
    customerName: 'TB. SUMBER NEGARA',
    description: 'TB. SUMBER NEGARA ANTAR',
  ...
  {
    id: '5',
    invoiceNumber: 'INV.2024.12.00485',
    customerName: 'TB. BINA SUBUR JAYA',
    description: 'TB. BINA SUBUR',
  ...
  {
    id: '6',
    invoiceNumber: 'INV.2024.12.00484',
    customerName: 'END USER (PKY)',
    description: 'IBU WINDRA',
    invoiceDate: '2024-11-01',
    salesPerson: 'SC - Santi',
    total: 15759500,
    status: 'PROCESSED',
...
export default function InvoicesPage() {
  ...
  return (
    <div className="flex flex-col h-[calc(100vh-6rem)] bg-white rounded-lg shadow-sm border border-surface-200 overflow-hidden">
      {/* 1. Header & Breadcrumbs (Simulated Tabs) */}
      <div className="flex items-center px-4 py-2 border-b border-surface-200 bg-surface-50">
        ...
        <div className="ml-auto flex items-center gap-2">
          {/* Window controls simulation if needed, but skipping for neatness */}
        </div>
      </div>
      ...
      <div className="flex items-center gap-2 px-4 py-2 border-b border-surface-200 bg-white overflow-x-auto">
        ...
        <FilterButton label="Branch" value="Main Office" removable />
            ...
            {filteredInvoices.map((invoice, index) => (
              <tr
                ...
                className={cn(
                  ...
                  index % 2 === 0 ? 'bg-white' : 'bg-surface-50/50' // Striped rows
                )}
              >
                ...
                <td className="px-4 py-2 font-medium text-warmgray-900">{invoice.invoiceNumber}</td>
                <td className="px-4 py-2 text-warmgray-600 whitespace-nowrap">{formatDate(invoice.invoiceDate)}</td>
                ...
                <td className="px-4 py-2">
                  <span className="font-semibold text-warmgray-700">{invoice.status}</span>
                </td>
      ...
      <div className="px-4 py-2 border-t border-surface-200 bg-surface-50 flex items-center justify-between text-xs text-warmgray-500">
        <span>Showing 1 to {filteredInvoices.length} of {filteredInvoices.length} items</span>

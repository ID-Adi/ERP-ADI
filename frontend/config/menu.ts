...
export const menuItems: MenuItem[] = [
    ...
    },
    {
        ...
        children: [
            ...
            { title: 'Pekerjaan Pesanan', href: '/dashboard/inventory/job-orders', icon: Hammer },
            { title: 'Penambahan Bahan Baku', href: '/dashboard/inventory/material-additions', icon: PlusCircle },
            { title: 'Penyelesaian Pesanan', href: '/dashboard/inventory/order-completions', icon: CheckCircle },
            ...
            { title: 'Pemenuhan Pesanan', href: '/dashboard/inventory/fulfillment', icon: ClipboardCheck },

...
export default function FakturView() {
                    ...
                    <table className="w-full text-sm text-left">
                        <thead className="text-xs text-white uppercase bg-warmgray-800 sticky top-0 z-10 w-full">
                            <tr>
                                ...
                                <Th>Status</Th>
                                <Th>Penjual Utama</Th>
                                <Th className="text-center">Umur (hr)</Th>
                            ...
                            {invoices.map((invoice: any, index: number) => {
                                ...
                                return (
                                    ...
                                    >
                                        ...
                                        <td className="px-4 py-2 text-center text-warmgray-600 font-medium">
                                            {invoice.age}
                                        </td>
                                        <td className="px-4 py-2 text-right text-warmgray-600">{formatCurrency(invoice.totalDiscount)}</td>
...
function TableSkeletonRow() {
    return (
        <tr className="animate-pulse bg-white border-b border-surface-100">
            <td className="px-4 py-3"><div className="h-4 w-24 rounded animate-shimmer"></div></td>
            <td className="px-4 py-3"><div className="h-4 w-20 rounded animate-shimmer"></div></td>
            <td className="px-4 py-3"><div className="h-4 w-32 rounded animate-shimmer"></div></td>
            <td className="px-4 py-3"><div className="h-4 w-40 rounded animate-shimmer"></div></td>
            <td className="px-4 py-3"><div className="h-5 w-20 rounded-full animate-shimmer"></div></td>
            <td className="px-4 py-3"><div className="h-4 w-24 rounded animate-shimmer"></div></td>
            <td className="px-4 py-3"><div className="h-4 w-8 mx-auto rounded animate-shimmer"></div></td>
            <td className="px-4 py-3"><div className="h-4 w-20 ml-auto rounded animate-shimmer"></div></td>
            <td className="px-4 py-3"><div className="h-4 w-24 ml-auto rounded animate-shimmer"></div></td>
        </tr>
    );
}
...
function Th({ children, className }: { children: React.ReactNode, className?: string }) {
    const align = className?.includes('text-right') ? 'justify-end' : className?.includes('text-center') ? 'justify-center' : 'justify-start';
    return (
        <th scope="col" className={cn("px-4 py-2 font-semibold whitespace-nowrap cursor-pointer hover:bg-warmgray-700 transition-colors", className)}>
